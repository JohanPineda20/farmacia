            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    <form id="form-crear">
                        ...
                        <div class="form-group">
                            ...
                            <input id="pass" type="password" class="form-control" placeholder="Ingrese Password"
                                required>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <button type="button" data-dismiss="modal"
                        class="btn btn-outline-secondary float-right m-1">Close</button>
                    </form>
                </div>
            </div>
        </div>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gestion Usurios <button type="button" data-toggle="modal" data-target="#crearusuario"
